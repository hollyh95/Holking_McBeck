...
namespace INTEX.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustID,CustName,CustDOB,CustPhone,CustEmail,CustStreetAddress1,CustStreetAddress2,LocID,AuthID,UserID")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustID,CustName,CustDOB,CustPhone,CustEmail,CustStreetAddress1,CustStreetAddress2,LocID,AuthID,UserID")] Customer customer)
        {
            if (ModelState.IsValid)
            {
